...
public class Line implements ICloneable 
{
	 ...
	 * @param	ep
	 */
	public function Line(sp:Vector2D, ep:Vector2D):void 
	{
		this.startPoint = sp;
		this.endPoint = ep;
	}
     ...
     * @return
     */
    public function isPerpendicular(line:Line):Boolean
	{
	 ...
	 * @return
	 */
	public function getSibling(line:Line):Object
	{
	 ...
	 * @return
	 */
    public function hasIntersection(line:Line):Boolean
	{
	 ...
	 * @return
	 */
	public function getRelation(line:Line):String
	{
	 ...
	 * @return
	 */
    public function getIntersectionPoint(line:Line):Object
	{
	 ...
	 * @return
	 */
    public function isIntersection(line:Line):Boolean
	{
    ...
    public function isContainPoint(point:Vector2D):Boolean
	{
		...
		var dx:Number = this.endPoint.x - this.startPoint.x;
		var dy:Number = this.endPoint.y - this.startPoint.y;
		var tempx:Number = (point.x - this.startPoint.x) / dx;
		var tempy:Number = (point.y - this.startPoint.y) / dy;
		if((tempx > 0 && tempx < 1) && (tempy > 0 && tempy < 1) && (tempx - tempy < .0000001))
		{
			return true; 
		}
		return false;
